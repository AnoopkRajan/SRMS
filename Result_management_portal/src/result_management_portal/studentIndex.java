    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            if(rs.next()){
                ...
                int total_marks = Integer.parseInt(rs.getString(8))+Integer.parseInt(rs.getString(9))+Integer.parseInt(rs.getString(10))+Integer.parseInt(rs.getString(11))+Integer.parseInt(rs.getString(12));
                jTextField12.setText(""+total_marks);
            }
            else{
